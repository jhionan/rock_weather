...
class ListElement {
  ...
  factory ListElement.fromJson(Map<String, Object> str) =>
      ListElement.fromMap(str);
...
class ForecastCurrent {
  ...
  factory ForecastCurrent.fromJson(Map<String, Object> str) =>
      ForecastCurrent.fromMap(str);
